...
public class AssetLoader {
    ...
    public static TextureRegion bg, grass, logo, zbLogo, playButtonUp, playButtonDown, scoreboard;

    public static Animation birdAnimation;
    public static TextureRegion bird, birdDown, birdUp;

    public static TextureRegion skullUp, skullDown, bar, ready, gameOver, highScore, star, noStar, retry;
